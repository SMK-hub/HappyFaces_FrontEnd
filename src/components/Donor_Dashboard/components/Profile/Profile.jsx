        ...
        <div>
            <p style={{ marginBottom: '10px' }}>Name:</p>
              ...
              <div className="button-group">
                <button style={{ backgroundColor: '#be72ab', border: 'none', color: 'white', padding: '10px 20px', fontSize: '16px', marginRight: '10px', cursor: 'pointer' }} onClick={handleSaveChangesClick}>Save Changes</button>
                <button style={{ backgroundColor: '#be72ab', border: 'none', color: 'white', padding: '10px 20px', fontSize: '16px', marginRight: '10px', cursor: 'pointer' }} onClick={() => setIsEditMode(false)}>Back</button>
              </div>
              </div>
            </div>
            ...
            <>
              ...
              {passwordMismatchError && <p className="donor-error-message">{passwordMismatchError}</p>}
              <div className="donor-button-group">
                <button style={{ backgroundColor: '#be72ab', border: 'none', color: 'white', padding: '10px 20px', fontSize: '16px', margin: '10px', cursor: 'pointer' }} onClick={handleSavePasswordChangesClick}>Save Password Changes</button>
                <button style={{ backgroundColor: '#be72ab', border: 'none', color: 'white', padding: '10px 20px', fontSize: '16px', margin: '10px', cursor: 'pointer' }} onClick={() => setIsChangePasswordMode(false)}>Back</button>
              </div>
            </>
          ) : (
            <div style={{display:'flex',flexDirection:'row'}}>
            <div className="donor-profile-picture">
            ...
            <div>
              <h2 style={{ marginBottom: '10px', fontFamily: 'Arial, sans-serif', fontSize: '20px', fontWeight: 'bold', color: '#333' }}>{userDetails?.name}</h2>
              <p style={{ marginBottom: '10px', fontFamily: 'Arial, sans-serif', fontSize: '16px', color: '#555' }}>Email: {userDetails?.email}</p>
              <p style={{ marginBottom: '10px', fontFamily: 'Arial, sans-serif', fontSize: '16px', color: '#555' }}>Contact no. : {userDetails?.contact}</p>
              <div className="donor-profile-buttons">
                <button className="donor-edit-profile-button" onClick={handleEditProfileClick}>
                  Edit Profile
                </button>
                <button className="donor-change-password-button" onClick={handleChangePasswordClick}>
                  Change Password
                </button>
              </div>
              </div>
